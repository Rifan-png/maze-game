...
min_width = 700
min_height = 500
wind= display.set_mode((min_width, min_height))
...
mushroom = GameSprite("game.png", min_width-120, min_height-80, 0)
turtle = Enemy("enemy.png", min_width-80, 200, 2)
...
while game:
    ...
    if finish != True:
        ...
        w3.draw_wall()
         ...
         #Lost game
        if sprite.collide_rect(mario, turtle) or sprite.collide_rect(mario, w1) or sprite.collide_rect(mario, w2) or sprite.collide_rect(mario, w3):
            finish = True
